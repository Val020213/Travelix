...
async def get_agency_by_id(agency_id:int=Path(...,title="The ID of the agency"),db:Session=Depends(get_db)):
...
async def remove_agency(agency_id:int=Path(...,title="The ID of the agency"),db:Session=Depends(get_db)):
